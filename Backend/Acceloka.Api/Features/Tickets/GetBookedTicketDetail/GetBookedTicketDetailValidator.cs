...
namespace Acceloka.Api.Features.Tickets.GetBookedTicketDetail
{
    public class GetBookedTicketDetailValidator : AbstractValidator<GetBookedTicketDetailQuery>
    {
        ...
        private readonly ILogger<GetBookedTicketDetailValidator> _logger;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public GetBookedTicketDetailValidator(AccelokaDbContext db, ILogger<GetBookedTicketDetailValidator> logger , IHttpContextAccessor httpContextAccessor)
        {
            _db = db;
            _logger = logger;
